...
import mainImg from "../assets/courtside.jpg";
...
const Home = () => {
  ...
  return (
    <div className="overflow-hidden">
      <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:mt-28 p-12 w-full">
        ...
        <div className="flex flex-col items-center justify-between text-center md:mt-24 mt-20 md:p-10 p-12 bg-red-900 md:bg-red-900 w-screen md:w-full rounded-md">
          <h1 className="md:font-bold md:text-4xl text-3xl text-amber-300">
            Earist Cavite Extension Programs of Information Technology
          </h1>
          <p className="hidden md:block mt-14 text-justify px-7 text-stone-100">
        ...
        <img src={bgImg} className="rounded-md w-[1024px]" />
      </div>
    <div className="flex flex-col md:flex-row gap-16 items-center justify-around">
      <div className="w-screen md:w-1/2 lg:w-1/3 h-8/12 p-8 ml-4 text-white text-center rounded-md mt-42 bg-gradient-to-l from-red-900 to-red-700">
        <h1 className="text-5xl mb-3 text-amber-300">
          Mission
        </h1>
        <p className="text-xl text-justify">
          Turn out vocationally, technically, technologically, and
          scientifically trained graduates who will be economically productive,
          self-sufficient, effective, responsible and discipline citizen of the
          Philippines.
        </p>
      </div>
      <div className="w-screen md:w-1/2 lg:w-1/3 h-8/12 p-8 mr-4 mb-3 text-white text-center rounded-md bg-gradient-to-r from-red-900 to-red-700">
        <h1 className="mb-5 text-5xl text-amber-300">
          Vision
        </h1>
        <p className="text-xl text-justify">
